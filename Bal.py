# Deobfuscated BY Dark-Hacker | Mr.Perfect

# Github    : https://github.com/dark-hacker
# Instagram : https://www.mrperfect5754
# Facebook  : https://fb.com/darkhacker07
# Messenger : https://m.me/darkhacker07 
...
--------------------------------------------------
 ...
 YouTube  : https://youtu.be/nSGu4ZfinqE
 Facebook : https://Facebook.com/darkhacker07
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtu.be/nSGu4ZfinqE')
            os.system('clear')
    else:
